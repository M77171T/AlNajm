...
3. The feature shall call the `ALNAJMCOIN_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `ALNAJMCOIN_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
