...
AlNajm Core 1.8.1 is primarily a bugfix release, bringing AlNajm Core in
line with Bitcoin 0.9.3. AlNajm Core 1.8.1 also adds in support for printing
...
## AlNajm Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by AlNajm Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 AlNajm Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/alnajm/alnajm/issues/134).
