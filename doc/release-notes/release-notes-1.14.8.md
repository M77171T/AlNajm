AlNajm Core version 1.14.8 is now available from:

  <https://github.com/alnajm/alnajm/releases/tag/v1.14.8/>

This is a new minor version release. AlNajm users on any platform are
...
Several important updates have been added to AlNajm Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, AlNajm Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way AlNajm Core
...
In previous versions of AlNajm Core, orphan transactions were processed in a
...
AlNajm Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in AlNajm Core.
...
* AlNajm Core now supports compilation with C++14 and C++17, if you select
