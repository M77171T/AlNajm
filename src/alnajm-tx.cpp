...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s alnajm-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  alnajm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alnajm transaction") + "\n" +
              "  alnajm-tx [options] -create [commands]   " + _("Create hex-encoded alnajm transaction") + "\n" +
              "\n";
