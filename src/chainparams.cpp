...
// Copyright (c) 2022-2024 The AlNajmCoin Core developers
...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in AlNajmCoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to AlNajmCoin values
