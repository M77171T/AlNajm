...
// AlNajm: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateAlNajmNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetAlNajmBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
