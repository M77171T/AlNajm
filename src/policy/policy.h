...
/** Recommended transaction fee by AlNajm Core developers
  *
 ...
 *
 *  AlNajm:    Increment mempool limits and accept RBF in steps of 0.0001 ALNAJM
...
/**
 * AlNajm: Default dust limit that is evaluated when considering whether a
...
/**
 * AlNajm: Default hard dust limit that is evaluated when considering whether
