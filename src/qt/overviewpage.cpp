...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the AlNajm Core repository on GitHub"),
        tr("Services that claim to double your alnajms are always ponzi schemes")
    };
