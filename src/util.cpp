...
const char * const BITCOIN_CONF_FILENAME = "alnajm.conf";
const char * const BITCOIN_PID_FILENAME = "alnajmd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AlNajm";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/AlNajm";
#else
    // Unix
    return pathRet / ".alnajm";
#endif
#endif
}
